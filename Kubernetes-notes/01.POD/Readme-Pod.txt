...
Pod is the smallest object that we can create in kubernetes.
...
Multiple container 
- of same kind(nginx) is not recommended in a pod.
- of different kind like - Helper container(side-car) -> Data pusher/puller, Proxies - allowed.
- Shared same network and storage.
